        ...
        <Carousel >
          ...
          <Carousel.Item interval={2000}>
            ...
            <blockquote style={{"font-size":"1vw"}} className="detail">
              ...
              20 Coupés and 20 Roadsters will be delivered to Lamborghini. This
              is the best car. My dream car"
              <div
                style={{ height: "1px", "margin-top": "5%" }}
                className="w-50 border border-secondary  bg-secondary"
              ></div>
          ...
          <Carousel.Item>
            ...
            <blockquote style={{"font-size":"1vw"}} className="detail">
              ...
              is top-notch which can not be compared by any brand."
              <div
                style={{ height: "1px", "margin-top": "5%" }}
                className="w-50 border border-secondary  bg-secondary"
              ></div>
